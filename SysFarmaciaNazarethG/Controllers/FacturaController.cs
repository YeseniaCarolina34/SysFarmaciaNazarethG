...
namespace SysFarmaciaNazarethG.Controllers
{
    ...
    public class FacturaController : Controller
    {
        ...
        {
            var bDContext = _context.Factura.Include(f => f.IdVentaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdFactura,IdProveedor,IdProducto,Cantidad,PrecioTotal,FechaDeEmisión,MétodoDePago,Estado,IdVenta")] Factura factura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFactura,IdProveedor,IdProducto,Cantidad,PrecioTotal,FechaDeEmisión,MétodoDePago,Estado,IdVenta")] Factura factura)
        {
